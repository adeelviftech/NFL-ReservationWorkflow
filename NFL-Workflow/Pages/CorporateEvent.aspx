            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Event Name" id="NameOfEvent" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Number of Attendees</label>
                        <input type="text" class="form-control" placeholder="Enter Attendees" id="NumberofAttendees" />
                    </div>
                </div>
            </div>
                        ...
                        <div class="">
                            <div class="input-group">
                                <input type="text" class="form-control timepicker"
                                    ...
                                    data-show-meridian="true" data-minute-step="5" data-second-step="5" id="TimeDuration" />
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="numofCabana" placeholder="Enter Cabana" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Number of Meeting Room Required</label>
                        <input type="number" class="form-control" id="numofmeetingRoomReq" placeholder="999" />
                    </div>
                </div>
                <!-- <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <tbody>
                        <tr class="tr_MedicalTable">
                            <td>
                                <div class="">
                                    <div class="input-groups">
                                        <input type="text" id="PlansDate" class="form-control datepicker" placeholder="Select Date"
                                            data-format="D, dd MM yyyy" />
                                        <i class="entypo-calendar"></i>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="">
                                    <div class="input-group">
                                        <input type="text" id="PlansTime" class="form-control timepicker"
                                            data-template="dropdown" data-show-seconds="true" data-default-text="0:00"
                                            data-show-meridian="true" data-minute-step="5" data-second-step="5" />
                                        <div class="input-group-addon"><a href="#"><i class="entypo-clock"></i></a></div>
                                    </div>
